...
export default function AppShowcase() {
  ...
  return (
    <div style={{ background: "#09090b", minHeight: "100vh", color: "#e0e0e0", fontFamily: "'Outfit', 'Helvetica Neue', sans-serif", position: "relative" }}>
      ...
      <nav style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(9,9,11,0.8)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1a1a1a", padding: "0 24px" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: "56px" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
            ...
            <button onClick={() => setTermOpen(true)} className="transition-colors hover:border-[#4ade80]" style={{ background: "#111", border: "1px solid #2a2a2a", color: "#4ade80", padding: "6px 14px", borderRadius: "6px", cursor: "pointer", fontSize: "12px", fontFamily: "'Commit Mono', monospace", display: "flex", alignItems: "center", gap: "6px" }}>
      ...
      <footer style={{ position: "relative", padding: "24px", textAlign: "center", color: "#333", fontSize: "12px", fontFamily: "'Commit Mono', monospace" }}>
